      ...
      <div className=" px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:space-x-8">
          ...
          <div className="hidden md:flex items-center p-4  flex justify-center ">
            <Link to="/">
              <div className="text-black hover:text-primary p-4">Home</div>
            </Link>
            <div class="group  relative dropdown  px-4 text-primary hover:text-p cursor-pointer  text-primary  tracking-wide">
              <Link to="/services">
                <div className="text-black hover:text-primary p-4">Services</div>
              </Link>
              <div class="group-hover:block dropdown-menu absolute hidden h-auto  bg-secondary">
                <ul class="top-0 w-48 bg-white shadow px-6 ">
                  <li class="py-1 "><Link to="/analysis" className="block  text-black bg-gray-400  hover:text-primary cursor-pointer">Analysis</Link></li>
                  <li class="py-1"><Link to="/testing" className="block text-black   hover:text-primary cursor-pointer">Testing</Link></li>
                </ul>
              </div>
            </div>
            <Link to="/pricing">
              <div className="text-black hover:text-primary p-4">Pricing</div>
            </Link>
            <Link to="/contact">
              <div className="text-black hover:text-primary p-4">
                Contact
              </div>
            </Link>
            <Link to="/aboutUs">
              <div className="text-black hover:text-primary p-4">About Us</div>
            </Link>
          </div>
            ...
            <li className="min-w-max">
              <Link to="/services">
                <div className="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray">
                  ...
                  <span className="group-hover:text-primary" onClick={serviceToggle}>Serivces</span>
                </div>
              </Link>
            </li>
            {
