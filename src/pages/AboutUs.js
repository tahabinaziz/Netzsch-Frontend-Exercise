...
const AboutUs =()=>{
    ...
    return(
        ...
        <header className="w-full h-16 bg-primary text-white flex justify-center items-center">
          <h1 className="font-medium text-2xl font-sans">About Us</h1>
        </header>
        <div className=" py-16 h-screen md:py-56 lg:py-24 xl:py-24">
              ...
              <form>
                <div className="w-4/5 mx-auto">
                  <div className=" mb-8 text-center">
                    <h1 className="text-white text-3xl">About Us Page</h1>
                  </div>
                  <button
                    onClick={onSubmit}
                    className="bg-white text-primary block  hover:bg-hoverColor  mx-auto  text-sm uppercase rounded shadow-md px-6 py-2"
                  >
                    Back
                  </button>
                </div>
